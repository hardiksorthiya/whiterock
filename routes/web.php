...
Route::prefix('backend')->name('backend.')->group(function () {
    ...
    Route::get('career-applications/{career_application}/cv', [CareerApplicationController::class, 'downloadCv'])->name('career-applications.cv');
...
Route::post('/career', [CareerController::class, 'store'])->middleware('throttle:10,1')->name('career.store');
